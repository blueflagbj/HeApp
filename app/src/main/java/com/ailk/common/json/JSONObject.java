...
public class JSONObject {
    ...
    public static <T> JSONObject fromObject(Map<String, T> map2) {
        return new JSONObject((Map<String, Object>) map2);
    }
    ...
    public static String doubleToString(double d) {
        ...
        while (string.endsWith(Global.SERVICE_PASSWORD)) {
            string = string.substring(0, string.length() - 1);
        }
        if (string.endsWith(FileUtils.HIDDEN_PREFIX)) {
    ...
    public boolean getBoolean(String key) throws JSONException {
        ...
        if (object.equals(Boolean.FALSE) || ((object instanceof String) && ((String) object).equalsIgnoreCase(Constant.FALSE))) {
            return false;
        }
        if (object.equals(Boolean.TRUE) || ((object instanceof String) && ((String) object).equalsIgnoreCase(Constant.TRUE))) {
            return true;
        }
    ...
    public static Object stringToValue(String string) {
        ...
        if (string.equalsIgnoreCase(Constant.TRUE)) {
            return Boolean.TRUE;
        }
        if (string.equalsIgnoreCase(Constant.FALSE)) {
    ...
    public static String valueToString(Object value) throws JSONException {
        ...
        if (value instanceof JSONString) {
            ...
            if (value instanceof Map) {
                return new JSONObject((Map<String, Object>) (Map) value).toString();
            }
            if (value instanceof Collection) {
                return new JSONArray((Collection<Object>) (Collection) value).toString();
            }
    ...
    public static Object wrap(Object object) {
        if (object == null) {
            ...
            if (object instanceof Collection) {
                return new JSONArray((Collection<Object>) (Collection) object);
            }
            if (object.getClass().isArray()) {
                return new JSONArray(object);
            }
            if (object instanceof Map) {
                return new JSONObject((Map<String, Object>) (Map) object);
            }
    ...
    static final Writer writeValue(Writer writer, Object value, int indentFactor, int indent) throws JSONException, IOException {
        if (value == null || value.equals((Object) null)) {
            ...
            new JSONObject((Map<String, Object>) (Map) value).write(writer, indentFactor, indent);
        } else if (value instanceof Collection) {
            new JSONArray((Collection<Object>) (Collection) value).write(writer, indentFactor, indent);
